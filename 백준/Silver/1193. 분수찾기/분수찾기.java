...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int squareCount = 1; // X의 해당 대각선에 있는 칸의 개수
        int squareSum =  0; // 해당 대각선의 직전 대각선까지의 칸을 누적 더하기 해서 저장하는 변수 (1/1보다 전은 없으니까 0)
        ...
        - 대각선의 칸 개수가 홀수일 경우
           squareCount - (X - squareSum - 1) + "/" + (X - squareSum)
        x = 4       값 = 3/1
        분자 : 3-(4-3-1)    = 3
        분모 : 4-3          = 1
        ...
        - 대각선의 칸 개수가 짝수일 경우
           (X - squareSum) + "/" + (squareCount - (X - squareSum - 1))
        x = 7       값 = 1/4
        분자 : 7-6          = 1
        분모 : 4-7-6-1      = 4
         */
        ...
        while (true) {
            // 해당 대각선의 직전 대각선 칸의 누적 칸 + 현재 해당하는 대각선의 칸의 개수보다 X번째가 작다는 것은
